              ...
              return (
                <Link key={item.href} href={item.href}>
                  ...
                  >
                    ...
                    {!isActive && (
                      <motion.div
                        className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-400 to-purple-400 opacity-0 group-hover:opacity-100"
                        initial={false}
            ...
            {loading ? (
              ...
              <div className="relative">
                <motion.button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-shadow"
                >
              ...
              <motion.button
                ...
                className="flex items-center space-x-2 px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-shadow"
              >
                <Wallet className="w-4 h-4" />
              ...
              <div className="pt-4 border-t border-gray-200">
                {loading ? (
                  ...
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    onClick={handleConnect}
                    className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg shadow-lg"
                  >
                    <Wallet className="w-4 h-4" />
                    <span className="text-sm font-medium">Connect Wallet</span>
                  </motion.button>
